...
function Checkout() {
  ...
  useEffect(() => {
    ...
    let tax = totalCartItem * 0.9;
    setTotalAmount((tax + (15 + total)).toFixed(2));
        ...
        <div className="mx-10 border">
          ...
          <div className="p-4 flex flex-col gap-4">
            ...
            <h2 className="flex justify-between">
              Delivery : <span>Rs.15.00</span>
            </h2>
            <h2 className="flex justify-between">
              Tax (9%) : <span>Rs.{(totalCartItem * 0.9).toFixed(2)}</span>
            </h2>
            <hr></hr>
            <h2 className="font-bold flex justify-between">
